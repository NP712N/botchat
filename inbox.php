...
$token   = "EAACW5Fg5N2IBAILHnauYFcOjcc3EUGa7aU1OZCxysVCD4fdGERAeTlV2zuy7Av3lwXl8F8jGtgB7dnGRWepFXxHvan6Aac2qgzDOCky13y8PJI3hmNGjDnidY7MmcVgleMZBkR2RDXv8xMOZC0lmImW1wT1BcSZAUGl7tbrTjwZDZD"; // Token fanpage => Cách lấy trong file hướng dẫn...
...
for ($i = 0; $i < count($getpage[data]); $i++) {
                if ($getpage[data][$i][unread_count] > 0) {
                                ...
                                if ($result) {
                                                ...
                                                if ($ok != 1) {
                                                                $traloi .= file_get_contents('http://simsimi.tristana-data.net/simsimi.php?text=' . $cmt);
                                                }
                                }
