...
$iduser = "100012085296978"; // ID Người Sử Dụng Simsimi Cmt
$token = "EAAAAUaZA8jlABADtXDLpIXfEKZBTU8FWRAu54UbbhdjSIThXrpMtWde0apmOJPQNxlvODgnWi09tFzHiZC1zBAxpzJdCL30rIh0N779fSZAOXqapeNeBSJtuezlPREkgXWUi3HkmnlniEQdONrSmgyCfxSyV9BbYyE3z9TgTETbFDvZB4yv1Ra4RQAdIxZB4UgCbhTKJ2HH7hK29cagsjZA"; // Token Của Nick simsimi
$limit = '1';  /*l sô bài cần like & CMT*/
$getID = json_decode(auto('https://graph.facebook.com/me?access_token='.$token.'&fields=id'),true);
$getStt = json_decode(auto('https://graph.facebook.com/'.$iduser.'/feed?limit='.$limit.'&access_token='.$token),true);
